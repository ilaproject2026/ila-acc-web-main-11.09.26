      ...
      case 'COURSE CREATOR':
        return <LibraryAndClassRoom onNavigateTab={(tab) => {
          if (tab === 'COURSE CREATE') {
            window.open('https://ila-ai-engine-hub091026.vercel.app/', '_blank', 'noopener,noreferrer');
          } else {
            setActiveTab(tab);
          }
          ...
          <div className="p-4 md:p-6 max-w-7xl mx-auto space-y-5 animate-in fade-in">
            <div className="bg-white p-5 md:p-6 rounded-2xl border border-slate-200 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="flex gap-2">
                ...
                <button onClick={() => { window.open('https://ila-ai-engine-hub091026.vercel.app/', '_blank', 'noopener,noreferrer'); }} className="px-3.5 py-2 bg-slate-900 hover:bg-slate-800 text-white text-xs font-bold rounded-xl transition-all shadow-xs flex items-center gap-1.5 cursor-pointer">
