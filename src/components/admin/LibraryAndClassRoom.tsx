      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-4 md:p-5 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 flex-wrap self-start md:self-center">
          ...
          <button
            ...
            className={`px-3.5 py-2 text-xs font-extrabold rounded-xl shadow-xs transition-all flex items-center gap-1.5 cursor-pointer ${activeAdminView === 'COURSE_LIST'
          ...
          <aside className="lg:col-span-3 xl:col-span-3 bg-white rounded-2xl border border-slate-200 shadow-xs flex flex-col overflow-hidden">
            ...
            <div className="p-3.5 bg-gradient-to-b from-slate-50 to-white border-b border-slate-100 space-y-2">
              <div className="flex items-center justify-between">
                <span className={`text-[10px] font-black uppercase tracking-wider px-2 py-0.5 rounded-md border ${isAICourse
              ...
              {chapterItems.map((item) => {
                ...
                return (
                  <div
                    ...
                    className={`py-2 px-2.5 rounded-lg flex items-center justify-between gap-2 text-xs transition-all cursor-pointer ${isSelected
                        ? 'bg-brand-50/90 text-brand-900 font-bold border-l-3 border-brand-600'
                        : 'text-slate-700 hover:bg-slate-50 hover:text-slate-900'
                      }`}
                  >
                    <div className="flex items-center gap-2 min-w-0">
                      <span className={`text-[11px] shrink-0 ${item.type === 'video' ? 'text-indigo-600' :
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                      ...
                      <span className={`w-2 h-2 rounded-full ${item.status === 'Complete' ? 'bg-emerald-500' :
            ...
            >
              ...
              <div className="px-4 py-2.5 bg-gradient-to-b from-black/95 via-black/60 to-transparent flex flex-wrap items-center justify-between gap-2 z-20">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <span className={`text-[9px] font-black px-2 py-0.5 rounded-full uppercase border ${activeCourse.aiLibrarySection === 'Video + AI Answering Classes'
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <div className="relative group">
                    <span className={`px-2.5 py-1 rounded-xl text-[10px] font-black uppercase flex items-center gap-1 cursor-pointer border ${activeCourse.testApprovalStatus === 'Approved'
                  ...
                  <button
                    ...
                    className={`p-1.5 rounded-xl border transition-all cursor-pointer ${showLiveTelemetryHUD
                      ...
                      {activeCourse.aiPayload?.sampleExercise && (
                        <div className="p-3.5 bg-indigo-950/60 rounded-xl border border-indigo-500/40 text-xs space-y-2">
                            ...
                            {activeCourse.aiPayload.sampleExercise.options.map((opt, oIdx) => {
                              ...
                              return (
                                <button
                                  ...
                                  className={`p-2 rounded-lg text-xs font-bold text-left transition-all border cursor-pointer ${showQuizFeedback && isSelected
                                      ? isCorrect
                          ...
                          {showQuizFeedback && selectedQuizAnswer && (
                            <div className={`p-2 rounded-lg text-[11px] font-bold ${selectedQuizAnswer === activeCourse.aiPayload.sampleExercise.correctAnswer
                ...
                <div className="flex items-center justify-between gap-3 text-xs">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className={`flex items-center gap-1 px-2.5 py-1.5 rounded-xl transition-all cursor-pointer ${isLiked ? 'bg-red-500/20 text-red-400' : 'bg-white/10 hover:bg-white/20 text-zinc-300 hover:text-red-400'
                    ...
                    <button
                      ...
                      className={`px-2 py-1 rounded-lg text-[10px] font-black border transition-all cursor-pointer ${showCaptions
        ...
        ========================================================================= */}
          <aside className="lg:col-span-3 xl:col-span-3 flex flex-col gap-3.5">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-xs overflow-hidden flex flex-col">
              <div className={`p-3 text-white flex items-center justify-between transition-colors ${isAICourse
                  ...
                  {!isAICourse ? (
                    <>
                      <button
                        ...
                        className={`px-2 py-1 text-[10px] font-bold rounded-lg transition-all cursor-pointer ${isTutorPaused ? 'bg-amber-400 text-slate-950 font-black' : 'bg-white/10 hover:bg-white/20 text-white'
                          }`}
                      ...
                      <button
                        ...
                        className={`p-1.5 rounded-lg transition-all cursor-pointer ${hasRaisedHand ? 'bg-yellow-400 text-slate-950' : 'bg-white/10 hover:bg-white/20 text-white'
                          }`}
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-xs p-3 flex flex-col h-[300px]">
              ...
              <div className="flex-1 overflow-y-auto space-y-2 pr-1 text-xs">
                {chatMessages.map((msg) => {
                  ...
                  return (
                    <div
                      key={msg.id}
                      className={`p-2 rounded-xl max-w-[92%] flex flex-col gap-0.5 ${isUser
              ...
              <form onSubmit={handleSendChat} className="mt-2 pt-2 border-t border-slate-100 flex items-center gap-1.5">
                <button
                  ...
                  className={`p-1.5 rounded-lg transition-all cursor-pointer shrink-0 ${isVoiceListening
                ...
                {subtitles.map((sub) => {
                  ...
                  return (
                    <div
                      ...
                      className={`p-2 rounded-lg border flex items-center justify-between gap-1.5 text-xs transition-all cursor-pointer ${isSubActive
                    ...
                    >
                      ...
                      <span className={`text-[8px] px-1.5 py-0.5 rounded font-bold shrink-0 ${isSubActive ? 'bg-brand-600 text-white' :
            ...
            <div className="flex items-center gap-2.5 flex-wrap">
              ...
              <div className="flex items-center bg-slate-100 p-1 rounded-2xl border border-slate-200 text-xs font-bold flex-wrap">
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-xl transition-all cursor-pointer flex items-center gap-1.5 ${librarySectionTab === 'ALL'
                      ? 'bg-white text-slate-900 shadow-xs font-black'
                      : 'text-slate-600 hover:text-slate-900'
                    }`}
                >
                  <span>All Classes</span>
                  <span className={`text-[10px] px-1.5 py-0.2 rounded-full font-mono ${librarySectionTab === 'ALL' ? 'bg-slate-900 text-white' : 'bg-slate-200 text-slate-700'
                    }`}>{courses.length}</span>
                </button>
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-xl transition-all cursor-pointer flex items-center gap-1.5 ${librarySectionTab === 'INTELLI_COACH'
                ...
                >
                  ...
                  <span className={`text-[10px] px-1.5 py-0.2 rounded-full font-mono ${librarySectionTab === 'INTELLI_COACH' ? 'bg-white text-indigo-900' : 'bg-slate-200 text-slate-700'
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-xl transition-all cursor-pointer flex items-center gap-1.5 ${librarySectionTab === 'VIDEO_AI'
                ...
                >
                  ...
                  <span className={`text-[10px] px-1.5 py-0.2 rounded-full font-mono ${librarySectionTab === 'VIDEO_AI' ? 'bg-white text-purple-900' : 'bg-slate-200 text-slate-700'
                    }`}>{videoAICount}</span>
                </button>
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-xl transition-all cursor-pointer flex items-center gap-1.5 ${librarySectionTab === 'TUTOR'
                ...
                >
                  ...
                  <span className={`text-[10px] px-1.5 py-0.2 rounded-full font-mono ${librarySectionTab === 'TUTOR' ? 'bg-white text-brand-900' : 'bg-slate-200 text-slate-700'
                    }`}>{tutorCount}</span>
                </button>
              </div>
            ...
            <div className="flex items-center gap-2.5 shrink-0">
              ...
              <div className="flex items-center bg-slate-100 p-1 rounded-2xl border border-slate-200">
                <button
                  ...
                  className={`p-1.5 rounded-xl transition-all cursor-pointer flex items-center gap-1 text-xs font-bold ${courseViewMode === 'GRID'
                ...
                <button
                  ...
                  className={`p-1.5 rounded-xl transition-all cursor-pointer flex items-center gap-1 text-xs font-bold ${courseViewMode === 'LIST'
                      ? 'bg-white text-brand-900 shadow-xs'
                      : 'text-slate-500 hover:text-slate-900'
                    }`}
              ...
              {filteredCourses.map((course) => {
                ...
                return (
                  <div
                    ...
                    className={`p-4 rounded-2xl border transition-all cursor-pointer flex flex-col justify-between group shadow-xs ${isCurrentlyActive
                  ...
                  >
                    <div>
                      ...
                      <div className="flex items-center justify-between gap-1.5 mb-2.5">
                        <span className={`text-[9px] font-black uppercase px-2 py-0.5 rounded-full border truncate max-w-[140px] ${isVideoAI
                        ...
                        <span className={`text-[9px] font-black px-2 py-0.5 rounded-full uppercase border shrink-0 ${course.testApprovalStatus === 'Approved'
                      ...
                      <div className="flex items-start gap-2.5 mb-2">
                        <div className={`w-9 h-9 rounded-xl flex items-center justify-center text-xs font-black shrink-0 ${isCurrentlyActive
                        ...
                        <div className="min-w-0">
                          <h4 className={`text-xs font-black line-clamp-1 transition-colors ${isCurrentlyActive ? 'text-brand-900' : 'text-slate-900 group-hover:text-brand-600'
                            }`}>
                            {course.name}
                          </h4>
                    ...
                    <div className="mt-3 pt-2.5 border-t border-slate-100 space-y-2 text-[10px]">
                      ...
                      <div className="pt-1">
                        <button
                          ...
                          className={`w-full py-2 rounded-xl text-xs font-black transition-all flex items-center justify-center gap-1.5 shadow-xs cursor-pointer ${isCurrentlyActive && isPlaying
              ...
              {filteredCourses.map((course) => {
                ...
                return (
                  <div
                    key={course.id}
                    onClick={() => selectCourse(course.id)}
                    className={`p-3.5 sm:px-5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 transition-all cursor-pointer ${isCurrentlyActive
                        ? 'bg-brand-50/80 border-l-4 border-brand-600 font-medium'
                        : 'bg-white hover:bg-slate-50'
                      }`}
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      <div className={`w-10 h-10 rounded-xl flex items-center justify-center text-xs font-black shrink-0 ${isCurrentlyActive ? 'bg-brand-600 text-white' : 'bg-slate-100 text-brand-700'
                        }`}>
                        {course.name.charAt(0)}
                      </div>
                      <div className="min-w-0">
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          <h4 className={`text-xs font-black truncate ${isCurrentlyActive ? 'text-brand-900' : 'text-slate-900'
                            }`}>
                            {course.name}
                          </h4>
                          <span className={`text-[9px] font-black uppercase px-2 py-0.5 rounded-full border ${isVideoAI
                              ? 'bg-purple-50 text-purple-700 border-purple-200'
                              : isCourseAI
                                ? 'bg-indigo-50 text-indigo-700 border-indigo-200'
                                : 'bg-brand-50 text-brand-700 border-brand-100'
                          ...
                          <span className={`text-[9px] font-black px-2 py-0.5 rounded-full uppercase border ${course.testApprovalStatus === 'Approved'
                              ? 'bg-emerald-100 text-emerald-800 border-emerald-300'
                              : course.testApprovalStatus === 'Requires Refinement'
                                ? 'bg-rose-100 text-rose-800 border-rose-300'
                                : 'bg-amber-100 text-amber-800 border-amber-300'
                    ...
                    <div className="flex items-center justify-between sm:justify-end gap-3 text-xs shrink-0">
                      ...
                      <button
                        ...
                        className={`px-3.5 py-1.5 rounded-xl text-xs font-black transition-all cursor-pointer flex items-center gap-1.5 shadow-xs ${isCurrentlyActive && isPlaying
                            ? 'bg-emerald-600 text-white'
                ...
                <div className="grid grid-cols-5 gap-2">
                  {[0.75, 1.0, 1.25, 1.5, 2.0].map((s) => (
                    <button
                      ...
                      className={`py-1.5 rounded-xl font-bold cursor-pointer transition-all ${playbackSpeed === s
